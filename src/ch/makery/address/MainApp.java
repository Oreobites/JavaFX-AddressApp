...
public class MainApp extends Application {
	...
	/*
	 *  Initializes the root layout and
	 *  tries to load the last opened person file.
	 */
	 ...
	 * If the user clicks OK, the changes are saved into the provided person object
	 ...
	 * i.e. the file that was last opened.
	 * The preference is read from the OS specific registry.
	 * If no such preference can be found,
	 * null is returned.
	 * 
	 * @return
	 */
